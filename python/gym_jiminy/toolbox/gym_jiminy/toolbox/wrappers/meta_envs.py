...
DecisionTreeT = Dict[Any, Tuple[float, "DecisionTreeT"]]
...
class CurriculumTaskWrapper(gym.Wrapper):
    def __init__(self,
                 ...
                 initial_task_tree: Optional[DecisionTreeT] = None
                 ) -> None:
        ...
        if initial_task_tree is None:
            initial_task_tree: DecisionTreeT = {}
    ...
    def reset(self) -> SpaceDictNested:
        # Sample task
